...
Sterownik platformy Azure wymaga identyfikatora subskrypcji. Możesz użyć [wiersza polecenia platformy Azure](/cli/azure/install-azure-cli) lub [witryny Azure Portal](https://portal.azure.com) można pobrać subskrypcji platformy Azure. 
