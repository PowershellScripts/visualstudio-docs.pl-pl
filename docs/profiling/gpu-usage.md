...
Począwszy od programu Visual Studio 2017, dane te można otworzyć za pomocą [narzędziem GPUView](/windows-hardware/drivers/display/using-gpuview) i [Analizator wydajności Windows](/windows-hardware/test/wpt/windows-performance-analyzer) , klikając **Otwórz w narzędziu GpuView** lub **Otwórz w narzędziu WPA** łącza znajdujący się w prawej dolnej części sesji diagnostycznej.
