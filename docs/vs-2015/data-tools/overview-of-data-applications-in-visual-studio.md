...
## <a name="in-this-section"></a>W tej sekcji  
 [Wskazówki: Tworzenie prostej aplikacji danych](http://msdn.microsoft.com/library/c5d0968c-d86f-4ae9-a2e1-871f208a3bb3)  
 Instrukcje krok po kroku dotyczące tworzenia aplikacji, która wyświetla dane z bazy danych.  
  
 [Dodawanie nowych źródeł danych](../data-tools/add-new-data-sources.md)  
 Omówienie pojęcia źródeł danych w programie Visual Studio.  
  
 [Dane lokalne — Przegląd](../data-tools/local-data-overview.md)  
 Zawiera opis funkcji w programie Visual Studio, który służy do pracy z bazami danych programu SQL Server Express i Access.  
 ...
 Zawiera łącza do danych związanych z instruktażami oraz informacje i łącza do pobierania przykładów danych.  
  
## <a name="related-sections"></a>Sekcje pokrewne  
 [O łączeniu z danymi w programie Visual Studio](../data-tools/connecting-to-data-in-visual-studio.md)  
 Opisuje sposób tworzenia połączeń z baz danych, usług sieci Web i obiektami z aplikacji.  
  
 [Przygotowanie aplikacji na odbieranie danych](http://msdn.microsoft.com/library/c17bdb7e-c234-4f2f-9582-5e55c27356ad)  
 Wyjaśnia, co to są typizowane zestawy danych i jak tworzyć i edytować poszczególne obiekty, które tworzą typizowane zestawy danych.  
 ...
 W tym artykule omówiono sposoby manipulowania danymi przed wysłaniem ich do źródła danych lub do innego procesu lub aplikacji.  
  
 [Sprawdzanie poprawności danych](http://msdn.microsoft.com/library/b3a9ee4e-5d4d-4411-9c56-c811f2b4ee7e)  
 Zawiera łącza do tematów opisujących sposób dodawania sprawdzania poprawności do zestawów danych.  
 ...
 Zawiera łącza do tematów dotyczących sposobu używania funkcji programu Visual Studio tworzenie aplikacji n warstwowych.  
 ...
 Zawiera łącza do tematów, które wyjaśniają jak działają dane w rozwiązaniach pakietu Office. Zawiera informacje dotyczące programowania zorientowanego na schemat, buforowaniu danych i dostęp do danych po stronie serwera.