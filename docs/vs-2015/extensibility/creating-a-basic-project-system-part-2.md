...
Najnowszą wersję tego tematu znajduje się w temacie [Tworzenie podstawowego systemu projektu, część 2](https://docs.microsoft.com/visualstudio/extensibility/creating-a-basic-project-system-part-2).  
