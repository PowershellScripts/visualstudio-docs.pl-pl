...
## <a name="general-security-considerations"></a>Zagadnienia dotyczące zabezpieczeń  
 ...
 [NIE w kompilacji: Bezpieczeństwo i programowania (C# i Visual Basic)](http://msdn.microsoft.com/en-us/227e2863-cf09-4c28-9611-bcd82be5e994)  
...
## <a name="securing-mobile-applications"></a>Zabezpieczanie aplikacji mobilnych  
 ...
 [Zagadnienia dotyczące zabezpieczeń dla urządzeń](http://msdn.microsoft.com/en-us/45fab484-8718-452e-8210-04fda3c6cb87)  
 W tym artykule opisano kilka czynników wpływających na zasad zabezpieczeń dla urządzeń.  
  
 [Cele zabezpieczeń dla platformy .NET Compact Framework](http://msdn.microsoft.com/en-us/64ac2770-e2bc-40a3-abbf-56c8a2c0e364)  
 W tym artykule opisano cele dotyczące zabezpieczeń platformy .NET Compact Framework.  
  
 [Projektowanie stron formularza bezpiecznej sieci Web z urządzeń przenośnych](http://msdn.microsoft.com/en-us/b69727c1-f81f-4221-a116-8f92f769365f)  
...
## <a name="securing-web-applications"></a>Zabezpieczanie aplikacji sieci Web  
 ...
 [Zagadnienia dotyczące zabezpieczeń dla języka JScript](http://msdn.microsoft.com/en-us/8572efc9-071a-472d-a1a4-f0a3b42644c1)  
 Szczegółowo opisuje niektóre pułapek zabezpieczeń, które mogą wystąpić w programowaniu w języku JScript.  
  
 [Porady: zabezpieczeń transportu](http://msdn.microsoft.com/en-us/16210e41-5492-4cc8-9002-7366b1fc7297)  
