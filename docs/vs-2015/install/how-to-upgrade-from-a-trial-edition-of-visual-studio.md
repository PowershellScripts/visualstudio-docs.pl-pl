---
title: 'Porady: uaktualnienie z wersji próbnej programu Visual Studio | Dokumentacja firmy Microsoft'
ms.custom: ''
ms.date: 11/15/2016
...
## <a name="see-also"></a>Zobacz też  
 [Zainstaluj program Visual Studio](../install/install-visual-studio-2015.md)   
 [Logowanie do programu Visual Studio](../ide/signing-in-to-visual-studio.md)   
 [Porady: Locate the Visual Studio Product Key](../install/how-to-locate-the-visual-studio-product-key.md)   
