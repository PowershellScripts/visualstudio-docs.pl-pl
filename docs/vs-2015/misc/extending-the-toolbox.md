...
## <a name="in-this-section"></a>W tej sekcji  
 [Porady: tworzenie kontrolki przybornika korzystającej z Windows Forms](../misc/how-to-create-a-toolbox-control-that-uses-windows-forms.md)  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 [Porady: kontrolowanie przybornika](http://msdn.microsoft.com/library/c9d8a18a-d2bc-43d4-a803-601bfc6a6599)  
