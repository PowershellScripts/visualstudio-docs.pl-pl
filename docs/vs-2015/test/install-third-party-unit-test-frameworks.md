...
3.  W **kategorii** listy, rozwiń **narzędzia** węzeł, a następnie wybierz **testowania**.  
  
4.  Wybieranie platformy na liście wyników, aby przejść do strony galerii Visual Studio, narzędzia.  
